...
export const academicSummary = [
	new CardHighlightClass(
		...
		'Presidential Honor List Awardee - Senior Year',
	...
	new CardHighlightClass(
		'https://upload.wikimedia.org/wikipedia/commons/thumb/6/68/Orange_tabby_cat_sitting_on_fallen_leaves-Hisashi-01A.jpg/1024px-Orange_tabby_cat_sitting_on_fallen_leaves-Hisashi-01A.jpg',
		'Presidential Honor List Awardee - Junior Year',
		'Achieved a cumulative GPA of 3.93/4.00 in my junior year',
		'New York Institute of Technology',
		'BS CompSci Student'
	),
	new CardHighlightClass(
		'https://upload.wikimedia.org/wikipedia/commons/thumb/6/68/Orange_tabby_cat_sitting_on_fallen_leaves-Hisashi-01A.jpg/1024px-Orange_tabby_cat_sitting_on_fallen_leaves-Hisashi-01A.jpg',
		'Presidential Honor List Awardee - Sophomore Year',
		'Achieved a cumulative GPA of 3.90/4.00 in my sophomore year',
		'New York Institute of Technology',
		'BS CompSci Student'
	),
	new CardHighlightClass(
		'https://upload.wikimedia.org/wikipedia/commons/thumb/6/68/Orange_tabby_cat_sitting_on_fallen_leaves-Hisashi-01A.jpg/1024px-Orange_tabby_cat_sitting_on_fallen_leaves-Hisashi-01A.jpg',
		'Presidential Honor List Awardee - Freshman Year',
		'Achieved a cumulative GPA of 3.93/4.00 in my freshman year',
		'New York Institute of Technology',
		'BS CompSci Student'
	),
]
