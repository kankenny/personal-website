    ...
    <div className="flex flex-col text-white space-y-10 h-full justify-between p-10 text-center ease-in-out">
      ...
      <div className="space-y-6">
        <div className="space-y-4">
          <p className="text-2xl font-light">Reach out to me here: </p>
          <div className="flex flex-col md:flex-row justify-center items-center gap-16">
            <a
              href="https://www.linkedin.com/in/kennette-basco/"
              target="_blank"
              rel="noreferrer noopener"
              className=" hover:text-gray-900 hover:text-main hover:scale-110 duration-200"
            >
              <svg
                stroke="currentColor"
                fill="currentColor"
        ...
        <div className="space-y-6 border-t border-t-white pt-6">
          ...
          <a
            href="https://drive.google.com/file/d/1IfEy88RKsBqeBMvI68j-i1g4g2dAev8v/view?usp=drive_link"
            target="_blank"
            rel="noreferrer noopener"
